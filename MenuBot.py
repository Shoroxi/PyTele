...
m_game_rsp_MP = Menu("Слоты", buttons=["Slots", "Menu", "language", "Выход"], parent=m_games, module="MyGame")
m_game_slots = Menu("Slots", buttons=["spin", "Выход"], parent=m_game_rsp_MP, module="MyGame")
